...
require 'databaseconnect.php';
		...
		if($qr){
			...
			$etype=$row['type'];
				...
				<?php echo "event name : ".$ename."<br>"; echo "event date : ".$edate."<br>"; echo "event type : ".$etype."<br>"; echo "event time : ".$etime."<br>"; echo "event venue : ".$evenue; ?><br><button style="margin-left:100px"><a href="eventreg.php" target="_blank" >Register</a></button></p></td>
