...
if(isset($_POST['add'])){
	...
	if((!empty($ename)) && (!empty($etype)) && !(empty($new_name)) && !(empty($edes))) {


	
		
				$qi="INSERT INTO `studentrequest`(`id`, `link`,`name`,`type`,`edes`,`sid`) VALUES (NULL,'$new_name','$ename','$etype','$edes','$sid')";
				$qrr=mysqli_query($mysqlc,$qi);
				
				
				if($qrr){
					echo "<script>alert('event request success')</script>";
  ...
  <section>
    <div class="container">
      <div class="user signinBx">
        ...
        <div class="formBx">
          <form action="organizeevents.php"  method="post" enctype="multipart/form-data">
            ...
            <br><br>
			Event description<input name="edes" type="text" size="100" /><br>
