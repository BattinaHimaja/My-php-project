...
if(isset($_FILES['userfile1']['name'])){
	...
	if(!empty($name)){
				...
				$qi="insert into `upeveupload`(`link`) values ('$new_name')";
  ...
  <section>
    <div class="container">
      <div class="user signinBx">
        <div class="imgBx"><img src="https://tse3.mm.bing.net/th?id=OIP.cXQAe_S_sMwLzDD_4FLk_wHaER&pid=Api&P=0&w=287&h=166" width=100px ></div>
        <div class="formBx">
          <form action="upcomingevents.php"  method="post" enctype="multipart/form-data">
            <h2>Add Upcoming Event</h2>
            <input type="file" name="userfile1" placeholder="event file" />
