...
if(isset($_FILES['userfile']['name'])){
	...
	if(!empty($name)){
				...
				$qi="insert into `events`(`link`) values ('$new_name')";
...
<form action='admineventsupload.php' method="POST" enctype="multipart/form-data">
file
...
<input type="submit" value="deleteevent" name="delete2">
